...
<body>
    ...
    try {
        ...
        echo "  <h1 id='titulo'>Sua carta foi enviada!</h1>";
        echo "  <h3 id='subtitulo'>Obrigado pelo seu tempo.</h3>";
        echo "  <h3 id='aviso'>Suas palavras. Suas ideias, seus sentimentos.</h3>";
        echo "  <h3 id='aviso'>Talvez algumas pessoas estejam ansiosas para saber o que você tem a dizer para elas.</h3>";
        echo "  <h3 id='aviso'>Ou talvez, elas nem te conheçam. Mas suas palavras agora a alcançam.</h3>";
        echo "</div>";
